...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react10.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useSafeState(state) {
  var isMounted = useMounted();
  return [state[0], (0, import_react11.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var InputGroup = React35.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime36.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames25.default)(className, bsPrefix, size2 && `${bsPrefix}-${size2}`, hasValidation && "has-validation")
    })
  });
});
...
var ModalDialog = React38.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var Modal = React40.forwardRef(({
  ...
  const [modalStyle, setStyle] = (0, import_react24.useState)({});
  const [animateStaticModal, setAnimateStaticModal] = (0, import_react24.useState)(false);
  const waitingForMouseUpRef = (0, import_react24.useRef)(false);
  const ignoreBackdropClickRef = (0, import_react24.useRef)(false);
  const removeStaticModalAnimationRef = (0, import_react24.useRef)(null);
  const [modal, setModalRef] = useCallbackRef();
  const mergedRef = useMergedRefs_default(ref, setModalRef);
  const handleHide = useEventCallback(onHide);
  const isRTL = useIsRTL();
  bsPrefix = useBootstrapPrefix(bsPrefix, "modal");
  const modalContext = (0, import_react24.useMemo)(() => ({
    onHide: handleHide
  }), [handleHide]);
  ...
  const renderBackdrop = (0, import_react24.useCallback)((backdropProps) => (0, import_jsx_runtime41.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React41.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime43.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames31.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime42.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime42.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React42.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
  ...
  const [exited, setExited] = (0, import_react26.useState)(!props.show);
...
var Popover = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime45.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime44.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime44.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  const overlayRef = (0, import_react27.useRef)(null);
  const popoverClass = useBootstrapPrefix(void 0, "popover");
  const offset2 = (0, import_react27.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
...
var Overlay2 = React45.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  const popperRef = (0, import_react28.useRef)({});
  const [firstRenderedState, setFirstRenderedState] = (0, import_react28.useState)(null);
  ...
  return (0, import_jsx_runtime46.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React45.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames33.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const triggerNodeRef = (0, import_react29.useRef)(null);
  const mergedRef = useMergedRefs_default(triggerNodeRef, children.ref);
  const timeout = useTimeout();
  const hoverStateRef = (0, import_react29.useRef)("");
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React46.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  const handleHide = (0, import_react29.useCallback)(() => {
    timeout.clear();
  ...
  const handleFocus = (0, import_react29.useCallback)((...args) => {
    handleShow();
    onFocus == null ? void 0 : onFocus(...args);
  }, [handleShow, onFocus]);
  const handleBlur = (0, import_react29.useCallback)((...args) => {
    handleHide();
    onBlur == null ? void 0 : onBlur(...args);
  }, [handleHide, onBlur]);
  const handleClick = (0, import_react29.useCallback)((...args) => {
    setShow(!show);
    onClick == null ? void 0 : onClick(...args);
  }, [onClick, setShow, show]);
  const handleMouseOver = (0, import_react29.useCallback)((...args) => {
    handleMouseOverOut(handleShow, args, "fromElement");
  }, [handleShow]);
  const handleMouseOut = (0, import_react29.useCallback)((...args) => {
  ...
  return (0, import_jsx_runtime49.jsxs)(import_jsx_runtime48.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react29.cloneElement)(children, triggerProps), (0, import_jsx_runtime47.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React47.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime50.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames34.default)(className, "page-item", {
      active,
      disabled
    }),
...
function createButton(name, defaultValue, label = name) {
  const Button = React47.forwardRef(({
    children,
    ...props
...
var Pagination = React48.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime52.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames35.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames36.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React49.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime53.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React50.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime55.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames37.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var ProgressBar = React51.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
  ...
  return (0, import_jsx_runtime55.jsx)("div", {
    ...
    children: children ? map(children, (child) => (0, import_react30.cloneElement)(child, {
      isChild: true
    })) : renderProgressBar({
      min: min2,
      now,
...
var Ratio = React52.forwardRef(({
  ...
  return (0, import_jsx_runtime56.jsx)("div", {
    ...
    className: (0, import_classnames38.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React52.Children.only(children)
  });
});
...
var Row = React53.forwardRef(({
  ...
  return (0, import_jsx_runtime57.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames39.default)(className, decoratedBsPrefix, ...classes)
  });
});
Row.displayName = "Row";
var Row_default = Row;
...
var Spinner = React54.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React55.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime60.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime59.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime59.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
...
function useTabPanel(_ref) {
  ...
  const context4 = (0, import_react31.useContext)(TabContext_default);
  if (!context4)
...
var TabPanel = React57.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var TabPane = React60.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastFade = React64.forwardRef((props, ref) => (0, import_jsx_runtime71.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastContext = React65.createContext({
...
var ToastHeader = React66.forwardRef(({
  bsPrefix,
  closeLabel = "Close",
  closeVariant,
  closeButton = true,
  ...
  const context4 = (0, import_react33.useContext)(ToastContext_default);
...
var ToggleButton = React69.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsxs)(import_jsx_runtime77.Fragment, {
    children: [(0, import_jsx_runtime76.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime76.jsx)(Button_default2, {
      ...props,
      ref,
