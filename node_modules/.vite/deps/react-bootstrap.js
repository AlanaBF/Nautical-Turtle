...
function useUncontrolledProp2(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react9.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
var ModalDialog = React34.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalHeader = React35.forwardRef(({
  ...
  return (0, import_jsx_runtime36.jsx)(AbstractModalHeader_default, {
    ref,
    ...props,
...
var Modal = React36.forwardRef(({
  ...
  const renderBackdrop = (0, import_react23.useCallback)((backdropProps) => (0, import_jsx_runtime37.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React37.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
  ...
  return (0, import_jsx_runtime39.jsxs)(Dropdown_default2, {
    ref,
    ...props,
    className: (0, import_classnames27.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime38.jsx)(Dropdown_default2.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
      ...
      as: NavLink_default,
      children: title
    }), (0, import_jsx_runtime38.jsx)(Dropdown_default2.Menu, {
      role: menuRole,
      renderOnMount: renderMenuOnMount,
      rootCloseEvent,
      variant: menuVariant,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React38.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var Popover = React40.forwardRef(({
  ...
  return (0, import_jsx_runtime41.jsxs)("div", {
    ...
    className: (0, import_classnames28.default)(className, decoratedBsPrefix, primaryPlacement && `bs-popover-${bsDirection}`),
    ...props,
...
var Overlay2 = React41.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime42.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React41.cloneElement(overlay, {
        ...
        popper: popper2,
        hasDoneInitialMeasure,
        className: (0, import_classnames29.default)(overlay.props.className, !transition && show && "show"),
        style: {
          ...overlay.props.style,
          ...overlayProps.style
        }
...
function OverlayTrigger({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React42.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime45.jsxs)(import_jsx_runtime44.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react28.cloneElement)(children, triggerProps), (0, import_jsx_runtime43.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React43.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime46.jsx)("li", {
    ref,
    style,
    className: (0, import_classnames30.default)(className, "page-item", {
      active,
      disabled
    }),
...
function createButton(name, defaultValue, label = name) {
  const Button = React43.forwardRef(({
    children,
    ...props
...
var Pagination = React44.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime48.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames31.default)(className, decoratedBsPrefix, size2 && `${decoratedBsPrefix}-${size2}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames32.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size2 && `${bsPrefix}-${size2}`, bg && `bg-${bg}`)
  };
}
...
var PlaceholderButton = React45.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime49.jsx)(Button_default2, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React46.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime51.jsx)("div", {
    ...
    ...props,
    role: "progressbar",
    className: (0, import_classnames33.default)(className, `${bsPrefix}-bar`, {
      [`bg-${variant}`]: variant,
...
var ProgressBar = React47.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React48.forwardRef(({
  ...
  return (0, import_jsx_runtime52.jsx)("div", {
    ...
    className: (0, import_classnames34.default)(bsPrefix, className, !isCustomRatio && `${bsPrefix}-${aspectRatio}`),
    children: React48.Children.only(children)
  });
});
...
var TabPane = React55.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var ToastContainer = React63.forwardRef(({
  bsPrefix,
  position,
  containerPosition,
  className,
...
var noop5 = () => void 0;
var ToggleButton = React64.forwardRef(({
  bsPrefix,
  name,
  className,
  checked,
...
var ToggleButtonGroup = React65.forwardRef((props, ref) => {
  const {
    children,
    type = "radio",
    name,
