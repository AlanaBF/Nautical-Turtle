  ...
  return (
    ...
    <h1 className='doodle-title'>Doodle Pad</h1>
      ...
      <label className="color-picker">
        Choose Color: {" "}
        <select className="color-picker-dropdown" value={color} onChange={handleColorChange}>
      ...
      <label className="line-width-picker">
        Line Width: {" "}
        <select className="line-width-picker-dropdown" value={lineWidth} onChange={handleLineWidthChange}>
      ...
      <label className="canvas-content-picker">
        ...
        <select className="canvas-content-picker-dropdown" value={canvasContent} onChange={handleCanvasChange}>
